...
RUN ansible-galaxy install -r requirements.yaml && ansible-playbook -i,localhost playbook.yaml --tags "install_utilities, install_oshw_tools, install_doctools" && rm -f ./*.yaml
